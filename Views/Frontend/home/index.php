<?php
include 'Views/Frontend/layouts/banner.php';
?>
      ...
      <div class="container">
            <div class="row">
                  <div class="col-lg-8 col-sm-12">
                        <div class="about_img"><img src="<?php echo ASSET_URL; ?>/images/about-img.png"></div>
                        <div class="like_icon"><img src="<?php echo ASSET_URL; ?>/images/like-icon.png"></div>
                        ...
                        <div class="social_icon_main">
                              <div class="social_icon">
                                    <ul>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/fb-icon.png"></a></li>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/twitter-icon.png"></a></li>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/instagram-icon.png"></a></li>
                                    </ul>
                              </div>
                  ...
                  <div class="col-lg-4 col-sm-12">
                        <div class="image_5"><img src="<?php echo ASSET_URL; ?>/images/img-5.png"></div>
...
<div class="about_section layout_padding">
      <div class="container">
            <div class="row">
                  <div class="col-lg-8 col-sm-12">
                        <div class="about_img"><img src="<?php echo ASSET_URL; ?>/images/img-8.png"></div>
                        <div class="like_icon"><img src="<?php echo ASSET_URL; ?>/images/like-icon.png"></div>
                        <p class="post_text">Post By : 09/06/2019</p>
                  ...
                  <div class="col-lg-4 col-sm-12">
                        <div class="about_main">
                              ...
                              <div class="follow_icon">
                                    <ul>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/fb-icon-1.png"></a></li>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/twitter-icon-1.png"></a></li>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/linkedin-icon-1.png"></a></li>
                                          <li><a href="#"><img src="<?php echo ASSET_URL; ?>/images/instagram-icon-1.png"></a></li>
                                    </ul>
                              </div>
                        </div>
                  </div>
...
<div class="about_section layout_padding">
      <div class="container">
            <div class="row">
                  <div class="col-lg-8 col-sm-12">
                        <div class="about_img"><img src="<?php echo ASSET_URL; ?>/images/img-9.png"></div>
                        <div class="like_icon"><img src="<?php echo ASSET_URL; ?>/images/like-icon.png"></div>
                        <p class="post_text">Post By : 09/06/2019</p>
...
<div class="about_section layout_padding">
      <div class="container">
            <div class="row">
                  <div class="col-lg-8 col-sm-12">
                        <div class="about_img"><img src="<?php echo ASSET_URL; ?>/images/img-10.png"></div>
                        <div class="like_icon"><img src="<?php echo ASSET_URL; ?>/images/like-icon.png"></div>
                        <p class="post_text">Post By : 09/06/2019</p>
                        ...
                        <div class="newsletter_main">
                              ...
                              <div class="recent_box">
                                    <div class="recent_left">
                                          <div class="image_6"><img src="<?php echo ASSET_URL; ?>/images/img-6.png"></div>
                                    </div>
                              ...
                              <div class="recent_box">
                                    <div class="recent_left">
                                          <div class="image_6"><img src="<?php echo ASSET_URL; ?>/images/img-7.png"></div>
                                    </div>
                                    <div class="recent_right">
                                          <h3 class="consectetur_text">Consectetur adipiscing</h3>
                                          <p class="dolor_text">ipsum dolor sit amet, consectetur adipiscing </p>
